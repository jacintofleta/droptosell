        ...
        <main className="flex flex-1">
          <div className="mx-auto space-y-4">
            <p>
              ...
              the use of Freelance Jacinto Fleta`s Website, located at
              droptosell.com.
            </p>

            <p>
              By accessing this website we assume you accept these terms and
              conditions. Do not continue to use Drop to Sell if you do not
            ...
            <p>
              ...
              Ourselves, We, Our and Us, refers to our Company. Party, Parties,
            ...
            <p>
              We employ the use of cookies. By accessing Drop to Sell, you
              agreed to use cookies in agreement with the Freelance Jacinto
              Fleta`s Privacy Policy.
            </p>
            ...
            <p>
              Unless otherwise stated, Freelance Jacinto Fleta and/or its
              licensors own the intellectual property rights for all material on
              Drop to Sell. All intellectual property rights are reserved. You
              may access this from Drop to Sell for your own personal use
              subjected to restrictions set in these terms and conditions.
            </p>

            <p>You must not:</p>
            <ul>
              <li>Republish material from Drop to Sell</li>
              <li>Sell, rent or sub-license material from Drop to Sell</li>
              <li>Reproduce, duplicate or copy material from Drop to Sell</li>
              <li>Redistribute content from Drop to Sell</li>
            </ul>

            <p>
              Parts of this website offer an opportunity for users to post and
              exchange opinions and information in certain areas of the website.
              Freelance Jacinto Fleta does not filter, edit, publish or review
              Comments prior to their presence on the website. Comments do not
              reflect the views and opinions of Freelance Jacinto Fleta,its
              ...
              permitted by applicable laws, Freelance Jacinto Fleta shall not be
            ...
            <p>
              Freelance Jacinto Fleta reserves the right to monitor all Comments
            ...
            <p>
              You hereby grant Freelance Jacinto Fleta a non-exclusive license
            ...
            <p>
              ...
              Freelance Jacinto Fleta; and (d) the link is in the context of
            ...
            <p>
              ...
              by sending an e-mail to Freelance Jacinto Fleta. Please include
            ...
            <p>
              No use of Freelance Jacinto Fleta`s logo or other artwork will be
