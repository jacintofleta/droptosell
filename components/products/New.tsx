...
export default function NewProduct({ file, setFile }: Props) {
  const { user } = useAuth();
          ...
          <div className="max-w-sm w-full bg-white shadow-lg rounded-lg pointer-events-auto ring-1 ring-black ring-opacity-5">
            {paymentLink ? (
              <div className="p-8">
                ...
                <div className="text-center text-xs text-teal-700 pt-5">
              ...
              <div className="p-8">
                ...
                <div className="text-center">
                  <button
                    ...
                    type="button"
                    className="content-center pt-5 border border-transparent text-xs text-red-500 font-medium "
                  >
                    Cancel
                  </button>
                </div>
